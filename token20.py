...
token6 = LINE() 
token6.log("Auth Token : " + str(token1.authToken)) 
token6.log("Timeline Token : " + str(token1.tl.channelAccessToken)) 

token7 = LINE() 
token7.log("Auth Token : " + str(token2.authToken)) 
token7.log("Timeline Token : " + str(token2.tl.channelAccessToken)) 

token8 = LINE() 
token8.log("Auth Token : " + str(token3.authToken)) 
token8.log("Timeline Token : " + str(token3.tl.channelAccessToken)) 

token9 = LINE() 
token9.log("Auth Token : " + str(token4.authToken)) 
token9.log("Timeline Token : " + str(token4.tl.channelAccessToken))

token10 = LINE() 
token10.log("Auth Token : " + str(token.authToken)) 
token10.log("Timeline Token : " + str(token.tl.channelAccessToken)) 

token11 = LINE() 
token11.log("Auth Token : " + str(token1.authToken)) 
token11.log("Timeline Token : " + str(token1.tl.channelAccessToken)) 

token12 = LINE() 
token12.log("Auth Token : " + str(token2.authToken)) 
token12.log("Timeline Token : " + str(token2.tl.channelAccessToken)) 

token13 = LINE() 
token13.log("Auth Token : " + str(token3.authToken)) 
token13.log("Timeline Token : " + str(token3.tl.channelAccessToken)) 

token14 = LINE() 
token14.log("Auth Token : " + str(token4.authToken)) 
token14.log("Timeline Token : " + str(token4.tl.channelAccessToken))

token15 = LINE() 
token15.log("Auth Token : " + str(token.authToken)) 
token15.log("Timeline Token : " + str(token.tl.channelAccessToken)) 

token16 = LINE() 
token16.log("Auth Token : " + str(token1.authToken)) 
token16.log("Timeline Token : " + str(token1.tl.channelAccessToken)) 

token17 = LINE() 
token17.log("Auth Token : " + str(token2.authToken)) 
token17.log("Timeline Token : " + str(token2.tl.channelAccessToken)) 

token18 = LINE() 
token18.log("Auth Token : " + str(token3.authToken)) 
token18.log("Timeline Token : " + str(token3.tl.channelAccessToken)) 

token19 = LINE() 
token19.log("Auth Token : " + str(token4.authToken)) 
token19.log("Timeline Token : " + str(token4.tl.channelAccessToken))
